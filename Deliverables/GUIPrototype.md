...
![Start Sale button](gui/Button/startsalebut.png?raw=true "Start Sale")
...
![Use case #2](gui/Presentation/usecase2.1_2.2..png?raw=true "Use case #2")
![Use case #2.3](gui/Presentation/usecase2.1.png?raw=true "Use case #2.3")
![Use case #2.1 2.2](gui/Presentation/usecase2.2.png?raw=true "Use case #2.1 2.2")

![Use case #4](gui/Presentation/usecase4.png?raw=true "Use case #4")
![Use case #4.234](gui/Presentation/usecase4.234.png?raw=true "Use case #4.234")
![Use case #4.1](gui/Presentation/usecase4.1.png?raw=true "Use case #4.1")
![End sale](gui/Presentation/endsale.png?raw=true "End sale")

![Manage accounts button](gui/Button/accounts.png?raw=true "Manage accounts button")
![Use case #11](gui/Presentation/usecase11.png?raw=true "Use case #11")
![Use case #12](gui/Presentation/usecase12.png?raw=true "Use case #12")

![Manage customers button](gui/Button/customers.png?raw=true "Manage customers button")
![Use case #9](gui/Presentation/usecase9.png?raw=true "Use case #9")
![Use case #10](gui/Presentation/usecase10.png?raw=true "Use case #10")


![Dashboard button](gui/Button/dashboard.png?raw=true "Dashboard button")
![Use case #13.1](gui/Presentation/usecase13.1.png?raw=true "Use case #13.1")
